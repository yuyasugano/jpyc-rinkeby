...
contract JPYC is ERC20, Ownable {
    ...
    address constant pc = 0x3F323f90C92239124f447D48835240d06ACBE53e;
    PriceConsumer constant con = PriceConsumer(pc);
    ...
    function burn(uint amount) public virtual onlyOwner {
    ...
    function deposit() public payable {
        int rate = con.getLatestPrice();
        require(rate > 0, "PriceConsumer: retrieve invalida rate");

        uint amount = msg.value.mul(uint(rate));
